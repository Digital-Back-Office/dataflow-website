      ...
      <div className="h-[50vh] w-3/5 flex">
        <div className="h-[50vh] w-3/12  flex flex-col justify-center items-start">
          ...
          <div className=" flex justify-between items-center">
            <button className="ease-in h-10 w-10 rounded-full border border-[#2FB7B8] flex items-center justify-center" onClick={prevTestimonial}>
              <img src="/arrowleft.png" alt="Previous" />
            </button>
            <p style={{ fontFamily: 'Arimo' }} className='mx-4'>{currentIndex + 1}/{testimonials.length}</p>
            <button className="ease-in h-10 w-10 rounded-full border border-[#2FB7B8] flex items-center justify-center" onClick={nextTestimonial}>
