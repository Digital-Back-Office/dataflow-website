      ...
      - label: "Solutions"
        ...
        columns:
          ...
          - heading: "Comparisons"
            span: 3
            items:
              - title: "Dataflow vs CoCalc"
                icon-id: "cocalc"
                description: "Compare cocalc with dataflow"
                href: "/compare/dataflow-vs-cocalc"
              - title: "Dataflow vs Deepnote"
                icon-id: "deepnote"
                description: "Compare deepnote with dataflow"
                href: "/compare/dataflow-vs-deepnote"
              - title: "Dataflow vs Databricks"
                icon-id: "databricks"
                description: "Compare databricks with dataflow"
                href: "/compare/dataflow-vs-databricks"
...
footer:
  ...
  sections:
    ...
    - heading: "Comparisons"
      links:
        - label: "Dataflow vs CoCalc"
          href: "/compare/dataflow-vs-cocalc"
        - label: "Dataflow vs Deepnote"
          href: "/compare/dataflow-vs-deepnote"
        - label: "Dataflow vs Databricks"
          href: "/compare/dataflow-vs-databricks"
