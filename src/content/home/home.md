...
supported_by:
  ...
  incubators:
    - name: 'Nat West'
      src: '/assets/images/nat-west-logo.png'
    - name: 'Barclays'
...
testimonials:
  ...
  testimonials:
    - name: "Lilia Bocouse"
      role: "Data Scientist"
      text: "As a Data Scientist, my primary focus is on deriving meaningful insights from data rather than managing complex technology infrastructure. Dataflow has been instrumental in allowing me to do just that, simplifying the process and letting me concentrate on what truly matters."

    - name: 'Alex Rivera'
      role: 'UI Designer'
      text: "The most intuitive tool I've used this year."
